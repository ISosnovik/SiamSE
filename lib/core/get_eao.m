...
addpath('PATH_TO_VOT_TOOLKIT'); toolkit_path; % Make sure that VOT toolkit is in the path

pwd = ['PATH_TO_VOT_TOOLKIT', 'vot-workspace', '2017']  % year is a str (can not be a number)
